...
public class ClientProgram {
    private static CustomClient ChatClient;
    ...
    private static JButton B_ECHO = new JButton();
    private static JButton B_PING= new JButton();
    ...
    public static JTextField TF_Password= new JTextField(20);
    ...
    public static void Connect(){
        ...
        try{
            ...
            ChatClient = new CustomClient(SOCK);
    ...
    public static void ConfigureMainWindow() {
        ...
        B_ECHO.setBackground(new java.awt.Color(0, 0, 255));
        B_ECHO.setForeground(new java.awt.Color(255, 255, 255));
        B_ECHO.setText("ECHO");
        MainWindow.getContentPane().add(B_ECHO);
        B_ECHO.setBounds(340, 40, 75, 25);

        B_PING.setBackground(new java.awt.Color(0,0,255));
        B_PING.setForeground(new java.awt.Color(255,255,255));
        B_PING.setText("PING");
        MainWindow.getContentPane().add(B_PING);
        B_PING.setBounds(425,40,75,25);
        ...
        {
            B_ENTER.addActionListener(evt -> ACTION_B_ENTER()
            );
        }

        public static void ACTION_B_ENTER(){
            if(!TF_UserNameBox.getText().equals("")&&TF_Password.getText().equals("Haslo123")){
                UserName=TF_UserNameBox.getText().trim();
                L_LoggedInAsBox.setText(UserName);
                ServerProgram.CurrentUsers.add(UserName);
                MainWindow.setTitle(UserName+"'s Chat Box");
    ...
    public static void ACTION_B_ECHO(){

        JOptionPane.showMessageDialog(null, ChatClient.echo("Echo test"));
    }
}
